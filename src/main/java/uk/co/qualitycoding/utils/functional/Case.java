...
public final class Case<A, B> {
    ...
    public Case(final Function<A, Boolean> chk, final Function<A, B> res) {
        this.check = chk;
        this.result = res;
    }

    public final Boolean predicate(final A a) {
        return check.apply(a);
    }

    public final B results(final A a) {
