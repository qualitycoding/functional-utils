...
/**
 * An implementation of {@link java.util.function.BiFunction} that is intended for use by the {@link uk.co.qualitycoding.utils.functional.MException}
 *
...
public abstract class BinaryFunction<A, B, C> implements BiFunction<A, B, C> {
    ...
    /**
     * Given a {@link uk.co.qualitycoding.utils.functional.function.Func2} and its two arguments, produce a function of no arguments that
