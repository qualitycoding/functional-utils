...
import uk.co.qualitycoding.utils.functional.primitive.integer.IntList;
...
import static uk.co.qualitycoding.utils.functional.FunctionalTest.doublingGenerator;
import static uk.co.qualitycoding.utils.functional.FunctionalTest.doublingGenerator_f;
    ...
    void integerListVsPrimitiveListToString() {
        for (final int howMany : new int[]{1000, 10000, 100000, 1000000, 10000000}) {
...

            {
                ...
                final IntList ints_l = uk.co.qualitycoding.utils.functional.primitive.integer.Functional.init(10, howMany);

                final long beforeTransformation = System.nanoTime();

                s2 = uk.co.qualitycoding.utils.functional.primitive.integer.Functional.join("", ints_l);
    ...
    void primitiveVsGenericFindLast() {
        for (final int howMany : new int[]{1000, 10000, 100000, 1000000, 10000000}) {
...

            {
                ...
                final IntList ints = uk.co.qualitycoding.utils.functional.primitive.integer.Functional.init(doublingGenerator_f, howMany);

                final long beforeTransformation = System.nanoTime();

                s2 = uk.co.qualitycoding.utils.functional.primitive.integer.Functional.findLast(a -> a < howMany / 2, ints);
